-- Sakila already exists since I am on PC, therefore I just need to use databse to do homework--
USE Sakila;
...
-- SELECT * FROM country;	
SELECT c.customer_id, first_name, last_name, email, country 
               FROM customer c
               JOIN address a
